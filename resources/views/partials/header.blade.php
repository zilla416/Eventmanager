<header class="flex flex-col">
    <div class="pt-6 pb-3 flex flex-row justify-between items-center border-b border-gray-200">
        ...
        <div class="flex flew-row items-center gap-3 border border-gray-300 rounded-lg text-md pl-4 pr-10 py-2 w-2xl">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor" class="size-6 text-gray-400">
                <path stroke-linecap="round" stroke-linejoin="round"
                    d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
            </svg>
            <input class="outline-none w-full" type="text" placeholder="Search for events, artists, teams, and more">
        </div>
        <div id="header-buttons" class="flex flex-row items-center gap-2 font-semibold">
            <a class="flex flex-row items-center gap-3 py-2 px-4 rounded-lg hover:bg-gray-200" href=""><img
                ...
                NL</a>
            <a class="py-2 px-4 rounded-lg hover:bg-gray-200" href="{{ route('register') }}">Sign In</a>
